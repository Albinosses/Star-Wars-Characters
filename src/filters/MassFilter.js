...
import { changeMinMass, changeMaxMass } from '../state/filters/filtersSlice'
...
const MassFilter = () => {
  ...
  useEffect(() => {
    reduxFilters.mass.min == null ? setMinMass('') : setMinMass(reduxFilters.mass.min)
    reduxFilters.mass.max == null ? setMaxMass('') : setMaxMass(reduxFilters.mass.max)
